---
name: distill-results
description: "distill-paper-exemplar L1 分发的 Results 分节蒸馏子代理——输入切片+PDM，产出 section JSON/feedback/写回 plan，只回 ≤20 行摘要。Not for: 直接写结果（用 write-results）；主循环自身不蒸馏。"
color: orange
