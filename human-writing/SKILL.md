---
name: human-writing
description: "通用中文创作与改稿：知乎回答、论坛长帖、公众号文章、博客、评论、人物故事、历史叙事、新闻与行业解读、科普、教程、评测、个人叙事、小说、故事、对白、口播和演讲稿，追求活人感与自然中文韵律，避免机构腔/营销腔/模型腔。触发词：写知乎、写公众号、写故事、写演讲稿、改稿"
whenToUse: "当用户要写或改中文创作类文稿（知乎/论坛长帖/公众号/博客/小说/故事/演讲稿/口播等），或嫌稿子有机构腔、营销腔、AI 腔时使用。触发词：帮我写个知乎回答、写篇公众号文章、写个故事、写演讲稿、改改这篇稿子、写得像真人一点"
---
