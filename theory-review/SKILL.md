...
- 反向检查：推导段声音若像"作者在回答想象中的审稿人"（每段承认-回应套路、协议术语泄漏进正文、防守句盖过主张句），按 `../write-theory/corpus/subprotocols/reasoning_soundness_protocol.md` §7 声音防火墙标记——**过度防御与防守缺失同样是声音问题**，顶刊论证的听觉中心是 claim 与机制推进。
