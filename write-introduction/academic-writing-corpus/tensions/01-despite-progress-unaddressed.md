...
exclusivity: HIGH
source_papers:
  - eilert2017 (JM, 2017): "predominantly focused on X and Y. However, little attention has been paid to Z"
  - wu2025 (SMJ, 2025): "Authority quote pivot → remains poorly understood"
  - darby2024 (MSOM, 2024): "Our review uncovered [N] studies... though none examine [gap]"
...
Incompleteness 问题化的核心 Tension：承认文献已有实质进展，但精确指出被遗漏的维度/机制/时点/对象。与 Inadequacy 的区别：不声称文献"理解偏了"，而是"做得好但不完整"。这是最常用的 Gap Tension——大多数实证论文属于此类型。

## 适用场景

- Gap 类型 = **Incompleteness**（已有所知，但漏了一块）
...
### 跨论文复现
- **VERIFIED** (≥4 papers): eilert2017 (JM), wu2025 (SMJ), darby2024 (MSOM), malshe2015 (JM) — 跨越营销、战略、运营管理
...
**模板**:
> "The [topic] literature has predominantly focused on [dominant focus 1] and [dominant focus 2]. However, little attention has been paid to [neglected focus]. By examining [our focus], our study offers insights on [value proposition]."
...
**关键特征**:
- "predominantly focused on X and Y" → 承认已有两个方向的研究
- "However, little attention has been paid to Z" → 精确指出第三个被忽略的方向
- 三段式：已有+然而+我们，节奏清晰

---

### 变体 B：权威引语转折型（wu2025 型）

**模板**:
> "[Authority], however, note that '[insightful quote]' (emphasis original). Yet, despite some noteworthy exceptions (e.g., [Exception A]; [Exception B]), [gap] remains poorly understood."

**来源**: wu2025 (SMJ), P2

**原文锚定**:
> "Parker et al. (2019: 254), however, note that 'the everyday reality for most firms consists not of responding to such crises but, rather, avoiding and preventing them in the first place' (emphasis original). Yet, despite some noteworthy exceptions... how firms respond in anticipation of, rather than in reaction to, stakeholder activism remains poorly understood."
...
### 变体 C：精确计数型（darby2024 型）

**模板**:
> "Our review of the literature uncovered [N] studies that spotlight [connection], though none of them examine [specific gap]. [Author A] found that [finding A]. [Author B] found that [finding B]. Most recently, [Author C] found that [finding C]. We build upon this nascent stream of research by examining whether [our focus]."

**来源**: darby2024 (MSOM), P2

**原文锚定**:
> "Our review of the literature uncovered three studies that spotlight a connection between a firm's CEO and recalls, though none of them examine recall timing."

**关键特征**:
- 用具体数字（"three studies"）建立文献稀缺感
- 简要引用每篇已有研究的发现，展示对文献的掌握
- "nascent stream" → 暗示新兴领域，缺口是自然的发展阶段

---

### 变体 D：多重原因论证型（malshe2015 型）

**模板**:
> "Yet little research investigates [gap]. This is surprising for [N] reasons. First, [empirical fact with citation]. Second, it is well documented that [established finding with citations]. Third, [additional mechanism/fact]. Therefore, [research question]."

**来源**: malshe2015 (JM), P2

**原文锚定**:
> "Yet little research investigates the effects of debt on marketing. This is surprising for three reasons. First, debt... is the preferred method of external financing for U.S. firms... Second, it is well documented... that firms with higher leverage tend to have lower investments... Third, higher debt makes it more difficult for firms to get new financing..."

**关键特征**:
- "This is surprising" → 不只说缺口存在，还解释为什么存在是令人惊讶的
- 每个原因都有具体数据或文献支撑
- 从原因自然过渡到 RQ
...
**模板**:
> "While important, much of the work on [topic] is [general/broad] and considers [X] in a [limited] sense. Research has yet to seriously consider [how/why] [specific question]. This omission is critical, as [phenomenon-level consequence]. Indeed, due to [uncertainty/tenuous relationship], no consensus [outcome] has emerged, and debate persists regarding [key question]. It also means that we know relatively little about [deeper why question]."

**来源**: gamache_etal2020 (SMJ), P2
...
**关键特征**:
- **三层递进**: 第1层=承认已有工作但批评其太general (mild Inadequacy undertone) → 第2层=指出specific gap ("how and why CEOs might pursue more specific...") → 第3层=升级为why层面的根本问题 ("we know relatively little about why")
- **Stakes嵌入Tension**: "This omission is critical, as..." 后接现象级后果(no consensus, debate persists)和理论后果(we know relatively little)
- 与标准 "few studies" 相比，能量更高——不是"没人做"，而是"做了一部分但不够specific，导致why层面仍然未知"
- 适合字数受限的SMJ/OS论文（可接受Stakes嵌入Tension），不适用于AMJ/ASQ（期望独立Stakes段）

**适用条件**:
- Gap确实是一个**递进结构**：现有文献→太general→specific缺口→why层面的根本问题
- 论文的核心贡献是回答"why"而非仅仅"what"
...
### 反模式提醒
- **弱缺口**: "few studies have examined..." 必须解释为什么少——是结构性的（新数据）、方法论性的（新方法）、还是理论性的（新视角）原因
- **不展示已有文献**: 必须先承认"文献做了什么"，才能说"遗漏了什么"。直接跳到缺口会显得稻草人
- **措辞过强**: Incompleteness 不应使用 "fundamentally wrong", "completely overlooked" 等 Incommensurability 措辞
- **滥用 "curiously silent"**: 只有在已有文献充分发展、且遗漏维度有明确证据时才使用；空白领域不宜使用
...
### `[gap statement]` — Incompleteness（文献做得好但漏了一块）

❌ "Few studies have examined how organizational learning and forgetting relate to each other." → 没说为什么少、为什么这个遗漏是结构性的。审稿人看到 "few studies" 自动反问 "so what?"
