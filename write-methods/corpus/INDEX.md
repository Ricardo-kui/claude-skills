...
| [非线性模型](非线性模型.md) | 非线性模型 | 22 | 2026-08-12；变体 20：M7 计数面板诊断三重链（过度分散→序列相关检验与修正→Hausman FE 选择），anand_mukherjee_2024，递进式补齐变体 1 未覆盖的两类后续诊断 |
