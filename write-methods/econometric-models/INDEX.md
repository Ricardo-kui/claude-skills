...
| [自然实验-DiD](自然实验-DiD.md) | 自然实验-DiD | 13 | 2026-08-05；变体 O（M8_judicial_shock_two_assumption，moon2026）、变体 P（M2_staggered_did_always_treated_hygiene，moon2026） |
...
| [两阶段模型](两阶段模型.md) | 两阶段模型 | 10 | 2026-08-12；变体 11（M7_heckman_disclosure_dual_peer_exclusion，moon2026） |
