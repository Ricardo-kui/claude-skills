...
| 核心贡献是识别 boundary condition / contingency | [`variants/E_moderation.md`](variants/E_moderation.md) | [`sentences/moderation.md`](sentences/moderation.md), [`subprotocols/E1_categorical_moderation.md`](subprotocols/E1_categorical_moderation.md) |
| 三向交互 (X x W1 x W2) | [`variants/E_moderation.md`](variants/E_moderation.md) E3 节 | — |
| 有中介的调节 (Moderated Mediation) | [`variants/E_moderation.md`](variants/E_moderation.md) E4 节 | — |
| 多调节器按层次/维度分类 | [`variants/E_moderation.md`](variants/E_moderation.md) E5 节 | — |
...
| [`B_mechanism_elaboration.md`](variants/B_mechanism_elaboration.md) | 机制推演型 | why chain 协议、多步机制、中介假设 | 主效应 + 中介 |
...
| [`E_moderation.md`](variants/E_moderation.md) | 调节效应型 | E1-E5 全协议：同层/跨层/分组/三向/中介调节/多层分类 | 主效应 + 调节（含复杂交互） |
...
| `01-despite-progress-unaddressed` | **B 机制推演型** | 遗漏机制 → 补充中介 why chain |
...
| C 假设树型 T6 Closure 缺失 | 假设树型 4+ 假设后无整合框架收束——理论碎片化，审稿人常见攻击点。实证证据: singh_grewal2023 (JMR) 4 假设后直接进入 Data 部分 |
