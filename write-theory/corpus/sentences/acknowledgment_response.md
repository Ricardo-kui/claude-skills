...
status: EMERGING
-->
> 论证角色：**A&R**——承认与回应材料（何时承认由 reasoning_soundness_protocol §4 决定，本文件管怎么写）；填位规则见 `../story-blueprints/v4/rhetoric-moves/_argument-grammar.md`（story-blueprints/v4/rhetoric-moves/）
