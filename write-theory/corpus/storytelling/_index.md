...
本目录存放 Pollock 2025 中 Theory & Hypotheses section 专用的叙事诊断工具。这些文件被 `write-theory` SKILL.md 的 Phase 0.5 和 Phase 0.75 **引用**。
...
| 文件 | 路径 | 引用位置 |
|------|------|---------|
| `prose-craft-checklist.md` | `../write-introduction/academic-writing-corpus/storytelling/prose-craft-checklist.md` | Phase 0.75 |
...
1. SKILL.md Phase 0.5 在路由完成后、输出骨架前读取本目录文件
2. 叙事检查结果附加到 Phase 3 QC 清单，不修改假设结构
