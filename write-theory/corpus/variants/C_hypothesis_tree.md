...
| # | 变体 | 家族 | 适用场景 | 状态 | 来源 |
|---|---|---|---|---|---|
| 基线互惠作为非假设前提 | 基线互惠作为非假设前提 | 假设树型 | — | 未标注（待核） | Pollock 2015 |
| 生命周期不对称 | 生命周期不对称（H1a/H1b） | 假设树型 | — | 未标注（待核） | Pollock 2015 |
| 路径依赖的时间衰减 | 路径依赖的时间衰减（H2） | 假设树型 | — | 未标注（待核） | Pollock 2015 |
| 大事件可见性效应 | 大事件可见性效应（H3a/H3b） | 假设树型 | — | 未标注（待核） | Pollock 2015 |
| 先验期望违背型水平调节 | 先验期望违背型水平调节（H4） | 假设树型 | — | 未标注（待核） | Pollock 2015 |
| 关键句式模板 | 关键句式模板 | 假设树型 | — | 未标注（待核） | 未标注（待补） |
| 假设陈述格式 | 假设陈述格式 | 假设树型 | — | 未标注（待核） | 未标注（待补） |
| Vidal & Mitchell 型 | Vidal & Mitchell 型：双极变化 × 行动方式的条件化假设树 | 假设树型 | — | EMERGING | Vidal & Mitchell |
