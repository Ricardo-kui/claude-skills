...
| # | 变体 | 家族 | 适用场景 | 状态 | 来源 |
|---|---|---|---|---|---|
| 关键句式模板 | 关键句式模板 | 竞争假设型 | — | 未标注（待核） | 未标注（待补） |
| 假设陈述格式 | 假设陈述格式 | 竞争假设型 | — | 未标注（待核） | 未标注（待补） |
| 技巧 1 | 技巧 1：自反性反机制（Self-Counter-Mechanism via "Conversely"） | 竞争假设型 | — | 未标注（待核） | wowak2025 |
| 技巧 2 | 技巧 2：多 DV 递进竞争（Progressive Multi-DV Competing Elaboration） | 竞争假设型 | — | 未标注（待核） | wowak2025 |
| 技巧 3 | 技巧 3：解释支配代理桥接 + 三向 cancel-out 收束（Competing Interpretations v | 竞争假设型 | — | 未标注（待核） | wowak2025 |
| 技巧 4 | 技巧 4：分离编号回指竞争对 + 期界基线 + 跨政策推广（Zajac & Westphal 2004, ASR） | 竞争假设型 | — | ROBUST | zajac_westphal_the_social_construction_of_market_value |
