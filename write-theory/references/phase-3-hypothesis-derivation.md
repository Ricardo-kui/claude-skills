...
**Soundness 五项**（前提最弱点 / 机制必要性门控 / 反例压力测试 / Warrant 表达三场合 / 声音防火墙）按 `../corpus/subprotocols/reasoning_soundness_protocol.md` §1–7 执行并在 Soundness Card 记录，本表不复述；Phase 4 审计 4 复核处置是否兑现。
